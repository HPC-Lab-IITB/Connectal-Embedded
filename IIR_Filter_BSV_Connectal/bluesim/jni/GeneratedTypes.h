...
typedef enum IfcNames { IfcNamesNone=0, PlatformIfcNames_MemServerRequestS2H=1, PlatformIfcNames_MMURequestS2H=2, PlatformIfcNames_MemServerIndicationH2S=3, PlatformIfcNames_MMUIndicationH2S=4, IfcNames_FromHardwareH2S=5, IfcNames_IntoHardwareS2H=6,  } IfcNames;
...
enum { CHAN_NUM_IntoHardware_hardware_input};
extern const uint32_t IntoHardware_reqinfo;

typedef struct {
    int32_t v;
} IntoHardware_hardware_inputData;
typedef union {
    IntoHardware_hardware_inputData hardware_input;
} IntoHardwareData;
int IntoHardware_handleMessage(struct PortalInternal *p, unsigned int channel, int messageFd);
typedef struct {
    PORTAL_DISCONNECT disconnect;
    int (*hardware_input) (  struct PortalInternal *p, const int32_t v );
} IntoHardwareCb;
extern IntoHardwareCb IntoHardwareProxyReq;
...
extern IntoHardwareCb IntoHardwareJsonProxyReq;

int FromHardware_hardware_output ( struct PortalInternal *p, const int32_t v );
enum { CHAN_NUM_FromHardware_hardware_output};
extern const uint32_t FromHardware_reqinfo;

typedef struct {
    int32_t v;
} FromHardware_hardware_outputData;
typedef union {
    FromHardware_hardware_outputData hardware_output;
} FromHardwareData;
int FromHardware_handleMessage(struct PortalInternal *p, unsigned int channel, int messageFd);
typedef struct {
    PORTAL_DISCONNECT disconnect;
    int (*hardware_output) (  struct PortalInternal *p, const int32_t v );
} FromHardwareCb;
extern FromHardwareCb FromHardwareProxyReq;
...
extern FromHardwareCb FromHardwareJsonProxyReq;
#ifdef __cplusplus
}
#endif
