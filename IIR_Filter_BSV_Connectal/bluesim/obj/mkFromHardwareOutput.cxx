...
/* Constructor */
MOD_mkFromHardwareOutput::MOD_mkFromHardwareOutput(tSimStateHdl simHdl,
						   char const *name,
						   Module *parent)
...
void MOD_mkFromHardwareOutput::init_symbols_0()
{
...
tUInt32 MOD_mkFromHardwareOutput::METH_portalIfc_messageSize_size(tUInt32 ARG_portalIfc_messageSize_size_methodNumber)
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_RDY_portalIfc_messageSize_size()
{
...
tUInt32 MOD_mkFromHardwareOutput::METH_portalIfc_indications_0_first()
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_RDY_portalIfc_indications_0_first()
{
...
void MOD_mkFromHardwareOutput::METH_portalIfc_indications_0_deq()
{
  INST_indicationPipes.METH_portalIfc_indications_0_deq();
}

tUInt8 MOD_mkFromHardwareOutput::METH_RDY_portalIfc_indications_0_deq()
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_portalIfc_indications_0_notEmpty()
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_RDY_portalIfc_indications_0_notEmpty()
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_portalIfc_intr_status()
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_RDY_portalIfc_intr_status()
{
...
tUInt32 MOD_mkFromHardwareOutput::METH_portalIfc_intr_channel()
{
...
tUInt8 MOD_mkFromHardwareOutput::METH_RDY_portalIfc_intr_channel()
{
...
void MOD_mkFromHardwareOutput::METH_ifc_hardware_output(tUInt32 ARG_ifc_hardware_output_v)
{
  INST_indicationPipes.METH_methods_hardware_output_enq(ARG_ifc_hardware_output_v);
}

tUInt8 MOD_mkFromHardwareOutput::METH_RDY_ifc_hardware_output()
{
  tUInt8 DEF_CAN_FIRE_ifc_hardware_output;
  tUInt8 PORT_RDY_ifc_hardware_output;
  DEF_CAN_FIRE_ifc_hardware_output = INST_indicationPipes.METH_RDY_methods_hardware_output_enq();
  PORT_RDY_ifc_hardware_output = DEF_CAN_FIRE_ifc_hardware_output;
  return PORT_RDY_ifc_hardware_output;
}


/* Reset routines */

void MOD_mkFromHardwareOutput::reset_RST_N(tUInt8 ARG_rst_in)
{
...
void MOD_mkFromHardwareOutput::set_clk_0(char const *s)
{
...
void MOD_mkFromHardwareOutput::dump_state(unsigned int indent)
{
  printf("%*s%s:\n", indent, "", inst_name);
...
unsigned int MOD_mkFromHardwareOutput::dump_VCD_defs(unsigned int levels)
{
...
void MOD_mkFromHardwareOutput::dump_VCD(tVCDDumpType dt,
					unsigned int levels,
					MOD_mkFromHardwareOutput &backing)
{
  vcd_defs(dt, backing);
  if (levels != 1u)
...
void MOD_mkFromHardwareOutput::vcd_defs(tVCDDumpType dt, MOD_mkFromHardwareOutput &backing)
{
  unsigned int num = vcd_num;
  if (dt == VCD_DUMP_XS)
  {
...
void MOD_mkFromHardwareOutput::vcd_submodules(tVCDDumpType dt,
					      unsigned int levels,
					      MOD_mkFromHardwareOutput &backing)
{
